      ...
      <div class="col-md-12">
        <div class="well well-custom">
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            <li class="active"><a href="manage-admin.php">Gerenciar admin</a></li>
            <li><a href="admin-manage-user.php">Gerenciar user</a></li>
          </ul>
          <div class="gap"></div>
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <div class="well">
                <h3 class="text-center bg-primary">Admin - Mudar senha</h3><br>
                        ...
                        ?>
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
                              <label class="control-label col-sm-4">Senha antiga</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-4">Nova senha</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-4">Confirmar nova senha</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-4 col-sm-3">
                                <button type="submit" name="btn_admin_password" class="btn btn-success-custom">Mudar</button>
                                
                              </div>
                              <div class="col-sm-3">
                                <a href="manage-admin.php" class="btn btn-danger-custom">Cancelar</a>
